...
class AdditionTests: QuickSpec {
    override func spec() {
        describe("adding small two numbers") {
            it("result in a number with no additional digit") {
                let x = [1, 0]
                let y = [2, 0]
                let expected = [3, 0]
            ...
            it("results in a number with additional digit") {
                let x = [9, 9]
                let y = [9, 9]
                let expected = [1, 9, 8]
        ...
        it("adding a big number which would lead to overflow with integer type") {
            ...
            let expected = [5, 8, 5, 9, 8, 7, 4, 4, 8, 2, 0, 4, 8, 8, 3, 8, 4, 7, 3, 8, 2, 2, 9, 3, 0, 8, 5, 4, 6, 3, 2, 1, 6, 5, 3, 8, 1, 9, 5, 4, 4, 1, 6, 4, 9, 3, 0, 7, 5, 0, 6, 5, 3, 9, 5, 9, 4, 1, 9, 1, 2, 2, 1, 9]
