...
//    func testKaratsubaSmall() throws {
//        let x = [1, 0]
//        let y = [2, 0]
//        let expect = [2, 0, 0]
//
//        let result = karatsubaMultiply(x: x, y: y)
//        print(result)
//        XCTAssertTrue(result.elementsEqual(expect))
//    }
    ...
    func testMedium() throws {
        let x = [1, 0, 4, 8, 1, 3, 5]
        let y = [8, 2, 3, 1, 1, 3]
        let expect = [8, 6, 2, 7, 3, 3, 5, 4, 4, 2, 5, 5]
    ...
    func testBig() throws {
        ...
        let expect = [8, 5, 3, 9, 7, 3, 4, 2, 2, 2, 6, 7, 3, 5, 6, 7, 0, 6, 5, 4, 6, 3, 5, 5, 0, 8, 6, 9, 5, 4, 6, 5, 7, 4, 4, 9, 5, 0, 3, 4, 8, 8, 8, 5, 3, 5, 7, 6, 5, 1, 1, 4, 9, 6, 1, 8, 7, 9, 6, 0, 1, 1, 2, 7, 0, 6, 7, 7, 4, 3, 0, 4, 4, 8, 9, 3, 2, 0, 4, 8, 4, 8, 6, 1, 7, 8, 7, 5, 0, 7, 2, 2, 1, 6, 2, 4, 9, 0, 7, 3, 0, 1, 3, 3, 7, 4, 8, 9, 5, 8, 7, 1, 9, 5, 2, 8, 0, 6, 5, 8, 2, 7, 2, 3, 1, 8, 4]
